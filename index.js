// This file is used to fix bug of browser-use==0.5.5
...
(
  ...
  function isHeuristicallyInteractive(element) {
    ...
    // 专用于owncloud
    const isTabHeader = /\b(subTabHeader|tab-header|tab-item)\b/i.test(element.className);
    if (isTabHeader) return true;
